        ...
        return (
            <nav className="navbar-menu">
                ...
                <ul className={classesDosOpcoes}>
                    <li>
                        <NavLink to="/quem-somos" activeClassName="navbar-links__ativo" onClick={this.handleOpcaoLink}>
                            Quem somos
                        </NavLink>
                    </li>
                    <li>
                        <NavLink to="/contato" activeClassName="navbar-links__ativo" onClick={this.handleOpcaoLink}>
                            Contato
                        </NavLink>
                    </li>
                    <li>
